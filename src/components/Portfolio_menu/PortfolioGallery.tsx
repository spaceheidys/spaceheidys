    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          ref={gridRef}
          className="w-full h-full grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-2 px-2 sm:px-2 py-1 sm:p-2"
        ...
        >
          {pageItems.map((item, i) => (
            <motion.div
              key={item.id}
              className="aspect-[3/4] bg-white/5 border border-white/10 rounded-md flex items-center justify-center cursor-pointer hover:bg-white/10 hover:border-white/20 transition-colors duration-300 overflow-hidden"
