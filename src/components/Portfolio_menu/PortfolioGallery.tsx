                  ...
                  <div className="sm:w-[280px] lg:w-[320px] flex flex-col justify-between p-4 sm:p-6 border-t sm:border-t-0 sm:border-l border-white/10 bg-black/95 overflow-y-auto max-h-[40vh] sm:max-h-none">
                    ...
                    <div className="mt-6 flex flex-col gap-3">
                      ...
                      <div className="flex items-center justify-center gap-3">
                       ...
                       <a
                         href={`https://x.com/intent/tweet?url=${encodeURIComponent(selectedEntry.project_url!)}&text=${encodeURIComponent(selectedEntry.label)}`}
                         target="_blank"
                         rel="noopener noreferrer"
                       ...
                       <a
                         href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(selectedEntry.project_url!)}`}
                         target="_blank"
                         rel="noopener noreferrer"
                         className="w-7 h-7 flex items-center justify-center border border-white/15 text-white/40 hover:text-white hover:border-white/40 transition-colors rounded-sm"
                       ...
                       <a
                         href={`https://t.me/share/url?url=${encodeURIComponent(selectedEntry.project_url!)}&text=${encodeURIComponent(selectedEntry.label)}`}
                         target="_blank"
                         rel="noopener noreferrer"
                         className="w-7 h-7 flex items-center justify-center border border-white/15 text-white/40 hover:text-white hover:border-white/40 transition-colors rounded-sm"
                       ...
                       <a
                         href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(selectedEntry.project_url!)}`}
                         target="_blank"
                         rel="noopener noreferrer"
                         className="w-7 h-7 flex items-center justify-center border border-white/15 text-white/40 hover:text-white hover:border-white/40 transition-colors rounded-sm"
