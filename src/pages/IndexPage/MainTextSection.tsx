        ...
        <div ref={ref} className="relative w-full bg-background h-[320px] sm:h-[380px] md:h-[420px]">
          <AnimatePresence mode="wait">
            ...
            {activeSection === "contact" && (
              <motion.div key="contact" className="absolute inset-0 flex items-center justify-center px-6 sm:px-8 md:px-16" {...sectionAnimation}>
            ...
            {activeSection === "shop" && (
              <motion.div key="shop" className="absolute inset-0 flex items-center justify-center px-6 sm:px-8 md:px-16" {...sectionAnimation}>
                <div className="text-sm sm:text-base text-foreground/80 font-body leading-relaxed max-w-2xl text-center">
